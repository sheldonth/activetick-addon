...
(function() {
  var ATBarHistoryTypes, ATConstituentRequestTypes, ATCountryTypes, ATCountryTypes_i, ATExchangeTypes, ATExchangeTypes_i, ATOptionTypes, ATOptionTypes_i, ATStreamRequestTypes, ATSymbolTypes, ATSymbolTypes_i, country_type_for_char, exchange_type_for_char, option_type_for_char, symbol_type_for_char, _;
  ...
  ATBarHistoryTypes = ['BarHistoryIntraday', 'BarHistoryDaily', 'BarHistoryWeekly'];

  module.exports = {
    ATConstituentRequestTypes: ATConstituentRequestTypes,
    ATStreamRequestTypes: ATStreamRequestTypes,
    ATBarHistoryTypes: ATBarHistoryTypes,
